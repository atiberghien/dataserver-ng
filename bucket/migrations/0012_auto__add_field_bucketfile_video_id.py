...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BucketFile.video_id'
        db.add_column(u'bucket_bucketfile', 'video_id',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BucketFile.video_id'
        db.delete_column(u'bucket_bucketfile', 'video_id')
