...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BucketFile.url'
        db.alter_column(u'bucket_bucketfile', 'url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'BucketFile.url'
        db.alter_column(u'bucket_bucketfile', 'url', self.gf('django.db.models.fields.TextField')(null=True))
