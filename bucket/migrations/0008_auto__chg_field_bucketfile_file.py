...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BucketFile.file'
        db.alter_column(u'bucket_bucketfile', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'BucketFile.file'
        db.alter_column(u'bucket_bucketfile', 'file', self.gf('django.db.models.fields.files.FileField')(default=None, max_length=255))
