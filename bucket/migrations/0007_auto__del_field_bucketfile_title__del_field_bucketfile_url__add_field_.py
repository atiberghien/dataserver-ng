...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BucketFile.title'
        db.delete_column(u'bucket_bucketfile', 'title')

        # Deleting field 'BucketFile.url'
        db.delete_column(u'bucket_bucketfile', 'url')

        # Adding field 'BucketFile.description'
        db.add_column(u'bucket_bucketfile', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'BucketFile.title'
        db.add_column(u'bucket_bucketfile', 'title',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'BucketFile.url'
        db.add_column(u'bucket_bucketfile', 'url',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'BucketFile.description'
        db.delete_column(u'bucket_bucketfile', 'description')
