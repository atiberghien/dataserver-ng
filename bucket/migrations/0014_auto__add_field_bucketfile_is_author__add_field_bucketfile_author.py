...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BucketFile.is_author'
        db.add_column(u'bucket_bucketfile', 'is_author',
    ...
    def backwards(self, orm):
        # Deleting field 'BucketFile.is_author'
        db.delete_column(u'bucket_bucketfile', 'is_author')
    ...
    models = {
        ...
        u'bucket.bucketfile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_author': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
