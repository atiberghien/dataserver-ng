...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectSheetTemplate.template_file'
        db.add_column(u'projectsheet_projectsheettemplate', 'template_file',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectSheetTemplate.template_file'
        db.delete_column(u'projectsheet_projectsheettemplate', 'template_file')
    ...
    models = {
        ...
        u'projectsheet.projectsheettemplate': {
            ...
            'slug': ('autoslug.fields.AutoSlugField', [], {'unique': 'True', 'max_length': '50', 'populate_from': "'name'", 'unique_with': '()'}),
            'template_file': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'})
        },
