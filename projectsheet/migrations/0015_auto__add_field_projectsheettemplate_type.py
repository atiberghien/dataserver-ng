...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectSheetTemplate.type'
        db.add_column(u'projectsheet_projectsheettemplate', 'type',
                      self.gf('django.db.models.fields.CharField')(default='P', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectSheetTemplate.type'
        db.delete_column(u'projectsheet_projectsheettemplate', 'type')
