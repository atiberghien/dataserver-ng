...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HistoricalProjectSheet.medias'
        db.add_column(u'projectsheet_historicalprojectsheet', 'medias',
                      self.gf('jsonfield.fields.JSONField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProjectSheet.medias'
        db.add_column(u'projectsheet_projectsheet', 'medias',
                      self.gf('jsonfield.fields.JSONField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HistoricalProjectSheet.medias'
        db.delete_column(u'projectsheet_historicalprojectsheet', 'medias')

        # Deleting field 'ProjectSheet.medias'
        db.delete_column(u'projectsheet_projectsheet', 'medias')
    ...
    models = {
        ...
        u'projectsheet.historicalprojectsheet': {
            ...
            'medias': ('jsonfield.fields.JSONField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
