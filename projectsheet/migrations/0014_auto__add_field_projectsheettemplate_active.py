...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectSheetTemplate.active'
        db.add_column(u'projectsheet_projectsheettemplate', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectSheetTemplate.active'
        db.delete_column(u'projectsheet_projectsheettemplate', 'active')
