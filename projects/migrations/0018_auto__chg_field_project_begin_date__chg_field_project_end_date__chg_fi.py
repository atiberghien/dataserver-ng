...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'projects_project', 'begin_date', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

        # Changing field 'Project.end_date'
        db.alter_column(u'projects_project', 'end_date', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

        # Changing field 'Project.slug'
        db.alter_column(u'projects_project', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique_with=['title'], max_length=50, populate_from='title'))

        # Changing field 'HistoricalProject.begin_date'
        db.alter_column(u'projects_historicalproject', 'begin_date', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

        # Changing field 'HistoricalProject.end_date'
        db.alter_column(u'projects_historicalproject', 'end_date', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

        # Changing field 'HistoricalProject.slug'
        db.alter_column(u'projects_historicalproject', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique_with=['title'], max_length=50, populate_from='title'))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Project.slug'
        db.alter_column(u'projects_project', 'slug', self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique_with=(), unique=True, populate_from=None))
        # Adding unique constraint on 'Project', fields ['slug']
        db.create_unique(u'projects_project', ['slug'])


        # Changing field 'HistoricalProject.begin_date'
        db.alter_column(u'projects_historicalproject', 'begin_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'HistoricalProject.end_date'
        db.alter_column(u'projects_historicalproject', 'end_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'HistoricalProject.slug'
        db.alter_column(u'projects_historicalproject', 'slug', self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique_with=(), populate_from=None))
