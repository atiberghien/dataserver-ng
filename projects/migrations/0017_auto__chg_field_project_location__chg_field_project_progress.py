...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'projects_project', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scout.Place'], null=True, on_delete=models.SET_NULL))

        # Changing field 'Project.progress'
        db.alter_column(u'projects_project', 'progress_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.ProjectProgress'], null=True, on_delete=models.SET_NULL))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Project.progress'
        db.alter_column(u'projects_project', 'progress_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.ProjectProgress'], null=True))
